...
public class RoomNodeSO : ScriptableObject
{
    ...
    /// <summary>
    /// Add childID to room node (returns true if the node has been added, false otherwise)
    /// </summary>
    ...
    private bool IsChildRoomValid(string childID)
    {
        ...
        {
            if (roomNode.roomNodeType.isBossRoom && roomNode.childRoomNodeIDList.Count > 0)
            {
        ...
        // If adding a room to a corridor check that this corridor node doesn't have already have a child room added
    ...
    /// <summary>
    /// Add parentID to room node (returns true if the node has been added, false otherwise)
    /// </summary>
    ...
    /// <summary>
    /// Remove childID from room node (returns true if the node has been removed, false otherwise)
    /// </summary>
    ...
    /// <summary>
    /// Remove parentID from room node (returns true if the node has been removed, false otherwise)
    /// </summary>
